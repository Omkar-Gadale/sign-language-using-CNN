# -*- coding: utf-8 -*-
"""
Created on Tue Jan 31 14:21:05 2023
...
title=tk.Label(root, text="Login", font=("Algerian", 30, "bold","italic"),bd=5,bg="skyblue",fg="white")
title.place(x=900,y=190,width=250)
        
Login_frame=tk.Frame(root,bg="skyblue")
Login_frame.place(x=885,y=300, width=275, height=400)
...
txtuser.grid(row=2,column=0,padx=20)
        
lblpass=tk.Label(Login_frame,text="Password",compound=LEFT,font=("Times new roman", 20, "bold"),bg="white").grid(row=3,column=0,padx=50,pady=10)
txtpass=tk.Entry(Login_frame,bd=5,textvariable=password,show="*",font=("",15))
txtpass.grid(row=4,column=0,padx=20)
        
btn_log=tk.Button(Login_frame,text="Login",command=login,width=15,font=("Times new roman", 14, "bold"),bg="Green",fg="black")
btn_log.grid(row=5,column=0,pady=10)
