...
def tf_predict(classifier, image):
	...
	pred_input_fn = tf.estimator.inputs.numpy_input_fn(x={"x":processed_array}, shuffle=False) #shuffle-takes a sequence, like a list, and reorganize the order of the items
